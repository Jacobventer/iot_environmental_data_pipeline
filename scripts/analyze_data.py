...
if invalid_records > 0:
    service_status =  "Environmental warnings detected"
    ...
    recommended_action = (
        "Review sensor quality before "
        "acting on alerts."
    )

    data_quality_message = (
        "Missing or invalid sensor values "
        "were detected."
    )
    ...
    recommended_action = (
        "Review alert areas and continue "
        "environmental monitoring."
    )

    data_quality_message = (
        "No missing or invalid sensor "
        "values detected."
    )

else:
    service_status = "Normal operation"
